...
function Home() {
  ...
  return (
    <div>
      ...
      {/* Upper Navigation Bar (Bootstrap styled) */}
      <nav className="navbar navbar-dark nav-bg px-4 shadow-sm mb-4 d-flex justify-content-between">
        <span className="navbar-brand mb-0 h1 fw-bold">Muser</span>
        
        <div className="d-flex align-items-center gap-3">
          {/* Display the username if they are logged in */}
          {user && <span className="text-light">Welcome, {user.username}!</span>}
