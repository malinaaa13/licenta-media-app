...
function Welcome() {
    return (
        <div className="container-fluid d-flex flex-column justify-content-center align-items-center vh-100 bg-light text-black">
            <h1 className="display3 fw-bold mb-4">Welcome to MediaApp</h1>
